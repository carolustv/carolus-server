...
pub fn all_movies(config: State<Config>, page_request: PageRequest) -> Json {
    ...
    Json(json!({
        "results": movies.into_iter().map(|m| Movie {
            id: m.id,
            title: m.title,
            background_image: "https://storage.googleapis.com/android-tv/Sample%20videos/Google%2B/Google%2B_%20Instant%20Upload/bg.jpg".to_owned(), //m.background_image,
            card_image: "https://storage.googleapis.com/android-tv/Sample%20videos/Google%2B/Google%2B_%20Instant%20Upload/card.jpg".to_owned(), //m.card_image,
